...
const fallback: Item[] = [
  ...
  { id: "f2", url: "https://rjsmqpneamauasuoqzct.supabase.co/storage/v1/object/public/review-photos//1efd5983-a49f-412e-8fa3-6b0ec5654ad7-2.png", name: "Pure Creatine Micronized", category: "Products", kind: "image", details: "200-mesh athletic performance phosphagen compound built to maximize systemic muscular cell hydration and intracellular ATP regeneration velocities.", specRef: "CREA-MICR-99" },
