...
const ProductDetail = () => {
  ...
  const gallery: MediaItem[] = useMemo(() => {
    ...
    if (product?.id === "pure-creatine") {
      return [
        { url: "https://rjsmqpneamauasuoqzct.supabase.co/storage/v1/object/public/review-photos//WhatsApp Image 2026-05-31 at 9.30.47 PM.jpeg", kind: "image" },
  ...
  const productSnapshots = useMemo(() => {
    ...
    if (product.id === "pure-creatine") {
      return [
        { url: "https://rjsmqpneamauasuoqzct.supabase.co/storage/v1/object/public/review-photos//WhatsApp Image 2026-05-31 at 9.30.47 PM.jpeg", tag: "Pure Micronized Mesh" },
