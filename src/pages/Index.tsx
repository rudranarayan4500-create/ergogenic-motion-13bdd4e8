...
const Index = () => {
  return (
    <div className="bg-background text-foreground">
      {/* HERO SECTION — Restored to original layout setup */}
      ...
      <section className="py-24 relative">
        ...
        <div className="container relative">
          <ScrollReveal className="text-center max-w-2xl mx-auto mb-14">
            ...
            <p className="mt-4 text-muted-foreground">Every product is formulated for real results. Explore our collection.</p>
          </ScrollReveal>
        </div>
      ...
      <section className="py-24 bg-muted/40 border-y border-border overflow-hidden">
        <div className="container">
          <div className="text-center max-w-3xl mx-auto mb-24">
            <p className="text-xs tracking-[0.4em] text-primary mb-3 uppercase">Featured Lineup</p>
          ...
          <div className="space-y-32">
            ...
            {/* Showcase 2 */}
            <div className="grid md:grid-cols-12 gap-10 lg:gap-20 items-center">
              <ScrollReveal direction="left" className="md:col-span-6 order-2 md:order-1 space-y-6">
                <span className="inline-flex text-[10px] bg-primary/15 text-primary px-4 py-1.5 rounded-full font-bold uppercase tracking-[0.25em]">
                  Performance
                </span>
                <h3 className="text-3xl lg:text-5xl font-extrabold text-foreground leading-tight">
            ...
            <div className="grid md:grid-cols-12 gap-10 lg:gap-20 items-center">
              ...
              <ScrollReveal direction="right" className="md:col-span-6 space-y-6">
                ...
                <Button asChild size="lg" className="shadow-glow bg-primary hover:bg-primary/90 text-white">
                  <Link to="/products">View Formula <ChevronRight className="ml-1 h-4 w-4" /></Link>
                </Button>
              </ScrollReveal>
            </div>
            ...
            <div className="grid md:grid-cols-12 gap-10 lg:gap-20 items-center">
              <ScrollReveal direction="left" className="md:col-span-6 order-2 md:order-1 space-y-6">
                ...
                <Button asChild size="lg" className="shadow-glow bg-primary hover:bg-primary/90 text-white">
                  <Link to="/products">Shop Collection <ChevronRight className="ml-1 h-4 w-4" /></Link>
                </Button>
              </ScrollReveal>
              <ScrollReveal direction="right" className="md:col-span-6 order-1 md:order-2">
                <div className="relative bg-card rounded-3xl border border-border overflow-hidden group shadow-2xl max-w-md mx-auto">
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="container relative z-10">
          <ScrollReveal className="text-center max-w-2xl mx-auto mb-14">
            ...
            <p className="mt-4 text-muted-foreground">A closer look at the key ingredients powering our formulations.</p>
          </ScrollReveal>
